...
results_file="../../results/results_two_state_test_leakyrelu_hill_normalized.csv"

model=two_state_abund_hill_normalized
e=200
...
do
    out_model=../../model_data/${model}model_b10_e${e}_L0.001_sMinMax_a${A}_c1_k${K}_ak${ak}_LeakyReLU_${np}PosKLoss_${wp}PosWeightLoss_hSplit_hv${hill_val}_seed${seed}_weightInit_v2
    echo $out_model
