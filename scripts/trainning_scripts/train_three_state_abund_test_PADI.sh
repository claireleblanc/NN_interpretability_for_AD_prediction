...
results_file="../../results/PADI_results_three_state_abund_test.csv"
...
do
    out_model=../../model_data/PADI_${model}model_b10_e${e}_L0.001_sMinMax_a${A}_c1_k${K}_ak${ak}_ParaReLU_${np}PosKLoss_${wp}PosWeightLoss_${ap}actLoss_hSplit_hv${hill_val}_seed${seed}_weightInit_v2
    out_folder=../../results/PADI_${model}model_b10_e${e}_L0.001_sMinMax_a${A}_c1_k${K}_ak${ak}_ParaReLU_${np}PosKLoss_${wp}PosWeightLoss_${ap}actLoss_hSplit_hv${hill_val}_seed${seed}_weightInit_v2
    echo $out_model
